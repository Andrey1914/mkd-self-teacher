...
const introAdjectives: ParagraphSectionsProps = {
  ...
  content: {
    text: `В македонском языке прилагательные и местоименные прилагательные (сюда влючаются порядковые числительные и местоимения,
      изменяемые как прилагательные) изменяются по родам и числам в зависимости от рода и числа определяющего слова.
    `,
  },
};

export default introAdjectives;
