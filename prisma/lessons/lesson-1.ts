  ...
  sections: [
    {
      ...
      content: {
        intro: {
          ...
          intro: `Македонский язык относится к южнославянской группе и сформировался как литературная система сравнительно недавно — в 
          середине XX века (в 1945 г). На протяжении долгого исторического периода судьбы жителей региона были тесно связаны с соседними
          народами, особенно с болгарами, что оставило след и в языковом развитии. Особенностью македонского и ряда других языков Балканского
          полуострова считается участие в так называемом Балканском языковом союзе — обширном ареале, где разные по происхождению языки
          приобрели сходные черты. Среди таких черт можно назвать исчезновение падежной системы у существительных и прилагательных, а
          также отсутствие инфинитива и ряд других параллельных процессов. Хотя македонский и болгарский языки имеют общие корни и
          некоторую взаимную близость, отдельные их диалекты настолько различаются, что носители могут с трудом понимать друг друга.
          После того как в Болгарии была создана современная литературная норма на базе восточных говоров, часть македонцев поддержала её
          использование, однако многие выступили за формирование собственной языковой системы, отражающей особенности местных говоров.
          Современный литературный македонский язык был официально утверждён в 1945 году на основе центральных диалектов. Сегодня он
          признаётся самостоятельным языком большинством специалистов. Тем не менее существуют иные точки зрения, согласно которым
          македонский рассматривается как часть болгарской диалектной территории. Дискуссия вокруг этого вопроса воспринимается в
          Македонии крайне чувствительно, поэтому важно относиться к теме с уважением и тактом.`,
